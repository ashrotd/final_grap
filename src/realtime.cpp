...
void Realtime::setUpTextures() {
    ...
    QImage sunTextureImage("./textures/sun_v1.png");
...
//    glPolygonMode( GL_FRONT_AND_BACK, GL_LINE );
    ...
    m_worleyShader = ShaderLoader::createComputeShaderProgram("Shaders/worley.comp");
    m_terrainShader = ShaderLoader::createShaderProgram("Shaders/terrain_generator.vert", ":/resources/shaders/terrain_generator.frag");
